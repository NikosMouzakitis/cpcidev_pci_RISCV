...
#define CPCIDEV(obj)        OBJECT_CHECK(CpcidevState, obj, TYPE_PCI_CUSTOM_DEVICE)
...
{
    CpcidevState *cpcidev = CPCIDEV(obj);
    cpcidev->dma_mask = (1UL << 28) - 1;
    object_property_add_uint64_ptr(obj, "dma_mask", &cpcidev->dma_mask, OBJ_PROP_FLAG_READWRITE, NULL);
